...
## 概述
 ...
 本简易网络库是对 Raw Socket 包含少量自定义协议的封装，提供成员发现、地址同步、组播收发和 TCP 连接建立等功能。
...
内部实现基于 [dependency](https://github.com/MechDancer/dependency) 提供的依赖项管理功能组织各个功能模块。
...
dependencies {
    compile 'org.mechdancer:remote:0.2.1-dev-13'
}
```
